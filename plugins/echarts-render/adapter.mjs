...
const script=fileURLToPath(new URL('./scripts/render-echarts.mjs',import.meta.url));
export async function health(context={}){const {ok,failure}=context.result||fallback;return fs.existsSync(script)?ok({available:true}):failure('DEPENDENCY_MISSING','未找到 ECharts 渲染脚本');}
