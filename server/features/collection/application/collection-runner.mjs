import { collectorFailure, normalizeCollectorResult, validateSourceConfiguration } from '../../../platform/collectors/contracts.mjs';
import { shouldFallback } from '../../../platform/tools/fallback-policy.mjs';
