...
import { buildConfigurationCatalog } from '../lib/extensions/configuration-catalog.mjs';
import { legacyToolConfiguration } from '../lib/extensions/legacy-tool-configuration.mjs';
import { legacyCollectorConfiguration } from '../lib/extensions/legacy-collector-configuration.mjs';
import { legacyModelProviderConfiguration } from '../lib/extensions/model-provider-configuration.mjs';
import { planLegacyConfigurationMigration, applyLegacyConfigurationMigration } from '../lib/extensions/legacy-configuration-migrator.mjs';
