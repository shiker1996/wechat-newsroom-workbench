...
import { buildToolCallBaseline } from '../lib/tools/dependency-baseline.mjs';
...
const output=path.join(root,'docs','tool-call-chain-baseline.json');fs.writeFileSync(output,`${JSON.stringify(baseline,null,2)}\n`,'utf8');
