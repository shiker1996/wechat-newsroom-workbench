# 月白清灰 · Social AI Design Spec

> 主题 ID：bone-white · 版本：1.0.1 · 目标：Social 图文视觉生成
...
|---|---|---|
| 画布背景 | #E7E7E5 | var(--bg) |
| 卡片表面 | #FFFFFF | var(--surface) |
| 页面底色 | #F5F5F3 | var(--page) |
| 正文/标题 | #222222 | var(--ink) |
| 辅助文字 | #777777 | var(--muted) |
| 主强调色 | #333333 | var(--accent) |
| 次强调色 | #AAAAAA | var(--accent2) |
| 分隔线 | #C7C7C4 | var(--line) |
| 深色表面反色文字 | #FFFFFF | var(--inverse) |
| 代码/深色表面 | #222222 | var(--code) |
...
| process-rail | 步骤、流程、执行循环或时间顺序 | editorial-split | 用节点、箭头或阶段条表达顺序；不改变步骤内容 |
