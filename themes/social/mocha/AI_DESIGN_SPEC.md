# 摩卡原木 · Social AI Design Spec

> 主题 ID：mocha · 版本：1.0.1 · 目标：Social 图文视觉生成
...
|---|---|---|
| 画布背景 | #E8DCCF | var(--bg) |
| 卡片表面 | #FFFAF4 | var(--surface) |
| 页面底色 | #FAF6F1 | var(--page) |
| 正文/标题 | #3D2B22 | var(--ink) |
| 辅助文字 | #7A5240 | var(--muted) |
| 主强调色 | #8B5C3F | var(--accent) |
| 次强调色 | #C99A6B | var(--accent2) |
| 分隔线 | #CBB29D | var(--line) |
| 深色表面反色文字 | #FFFFFF | var(--inverse) |
| 代码/深色表面 | #30211B | var(--code) |
