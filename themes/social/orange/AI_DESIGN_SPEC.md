# 落日橙界 · Social AI Design Spec

> 主题 ID：orange · 版本：1.0.1 · 目标：Social 图文视觉生成
...
|---|---|---|
| 画布背景 | #1A1200 | var(--bg) |
| 卡片表面 | #302009 | var(--surface) |
| 页面底色 | #251700 | var(--page) |
| 正文/标题 | #FFF5E6 | var(--ink) |
| 辅助文字 | #D4A85E | var(--muted) |
| 主强调色 | #FF7A00 | var(--accent) |
| 次强调色 | #FFD166 | var(--accent2) |
| 分隔线 | #704212 | var(--line) |
| 深色表面反色文字 | #0F0A00 | var(--inverse) |
| 代码/深色表面 | #0F0A00 | var(--code) |
...
```html
<div class="orange-feat-card">
  <div class="orange-feat-icon">✦</div>
  <div class="orange-feat-title">核心亮点</div>
  <div class="orange-feat-body">这里放事实清单和故事板允许表达的一到两句内容。</div>
</div>
```
