# 东京之夜 · Social AI Design Spec

> 主题 ID：tokyo-night · 版本：1.0.1 · 目标：Social 图文视觉生成
...
|---|---|---|
| 画布背景 | #16161E | var(--bg) |
| 卡片表面 | #24283B | var(--surface) |
| 页面底色 | #1A1B26 | var(--page) |
| 正文/标题 | #C0CAF5 | var(--ink) |
| 辅助文字 | #9AA5CE | var(--muted) |
| 主强调色 | #4672CE | var(--accent) |
| 次强调色 | #BB9AF7 | var(--accent2) |
| 分隔线 | #414868 | var(--line) |
| 深色表面反色文字 | #FFFFFF | var(--inverse) |
| 代码/深色表面 | #101014 | var(--code) |
...
|---|---|---|---|
| metric-focus | 数字、比例、价格、规模或版本 | statement | 用 accent 或 accent2 放大事实；使用 soft 投影，不新增数字 |
