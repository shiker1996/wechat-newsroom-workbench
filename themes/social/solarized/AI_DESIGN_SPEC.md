# 极光配色 · Social AI Design Spec

> 主题 ID：solarized · 版本：1.0.1 · 目标：Social 图文视觉生成
...
| 页面底色 | #FDF6E3 | var(--page) |
| 正文/标题 | #073642 | var(--ink) |
| 辅助文字 | #657B83 | var(--muted) |
| 主强调色 | #0E7A70 | var(--accent) |
| 次强调色 | #B58900 | var(--accent2) |
| 分隔线 | #93A1A1 | var(--line) |
| 深色表面反色文字 | #FFFFFF | var(--inverse) |
| 代码/深色表面 | #002B36 | var(--code) |
