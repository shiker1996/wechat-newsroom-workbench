...
const viewModules = {
  dashboard: '', batches: '/app-overview.js', overview: '/app-overview.js',
  topics: '/app-pool-editorial.js', editorial: '/app-pool-editorial.js',
  editor: '/app-editor-production.js', preview: '/app-editor-production.js',
  hotspots: '/app-overview.js', artifacts: '/app-overview.js',
  system: '/app-models-logs.js', sources: '/app-models-logs.js', models: '/app-models-logs.js',
  logs: '/app-models-logs.js', calendar: '/app-models-logs.js',
};
const loadedScripts = new Set();
function ensureModule(view) {
  const src = viewModules[view];
  ...
  return new Promise(function(resolve, reject) {
    ...
    s.onerror = function() { reject(new Error('模块加载失败: ' + src)); };
...
﻿function bind() {
  ...
  document.addEventListener('click', (event) => {
    ...
    if (artifact) { const dialog = $('#artifact-dialog'); $('iframe', dialog).src = `/api/documents/${artifact.dataset.artifact}/content`; dialog.showModal(); }
...
async function init() {
  ...
  try { await ensureModule('overview'); await loadOverview(); await go(initialView); } catch (error) { toast('工作台加载失败：' + error.message); }
}
