...
export const coverTokenGroups={
  typography:{label:'字体与字阶',hint:'控制封面大标题、眉题、副标题与信息行的字号层级',fields:[
    ['family','正文字体','select',['sans','serif','song','kai','hei','mono']],['headingFamily','标题字体','select',['sans','serif','song','kai','hei','mono']],
...
export const optionLabels={sans:'系统无衬线',serif:'兼容衬线',song:'宋体',kai:'楷体',hei:'黑体',mono:'等宽',none:'无',soft:'柔和阴影',hard:'硬边阴影',glow:'发光',grid:'网格',scanlines:'扫描线','paper-grain':'纸张颗粒',accent:'强调色',ink:'正文墨色'};
