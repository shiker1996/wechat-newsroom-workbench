...
test('Python 抓取器从 HTML 提取结构化来源和正文', (t) => {
  ...
  const output=execFileSync(python,['-X','utf8','-c',code,script,fixture],{encoding:'utf8'});
...
test('Python 抓取器拒绝本机与内网 URL', (t) => {
  if(!python)return t.skip('未发现可用 Python 3 运行时');
  const output=execFileSync(python,['-X','utf8',script,'--url','http://127.0.0.1:4317/'],{encoding:'utf8'});
