...
test('阶段 2 用户提示不再要求直接编辑业务密钥环境变量',()=>{
  const tavily=fs.readFileSync('plugins/tavily-search/adapter.mjs','utf8');const upyun=fs.readFileSync('skills/upyun-upload-image/SKILL.md','utf8');const info=fs.readFileSync('lib/integrations/information-search.mjs','utf8');
