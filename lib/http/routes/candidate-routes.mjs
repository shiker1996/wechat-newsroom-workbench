...
export async function handleCandidateRoutes({ request, response, pathname, searchParams, root, config, store, body, json, models, aiJobs,
  ...
  return handleIndependentCreation({ request, response, pathname, root, config, store, body, json, aiJobs, articleWorkdir, writeUtf8, readLocalProject, resolveSkillToolPolicy, resolveArticleStageSkills, resolveEntryWriterSkill, buildCustomFactSheet, attachInformationSearch, customArticleFingerprint });
}

async function handleIndependentCreation({ request, response, pathname, root, config, store, body, json, aiJobs, articleWorkdir, writeUtf8, readLocalProject, resolveSkillToolPolicy, resolveArticleStageSkills, resolveEntryWriterSkill, buildCustomFactSheet, attachInformationSearch, customArticleFingerprint }) {
