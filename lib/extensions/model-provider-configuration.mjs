...
export function modelProviderManifest(id,provider={}) {
  const properties={
...
export function legacyModelProviderConfiguration(provider={},environment=process.env) {
  const values={};
  for(const key of ['label','baseUrl','model','contextWindow','maxOutputTokens','maxTokensField','taggingChunkSize','taggingConcurrency','supportsJsonMode','supportsThinkingToggle','thinkingReserveTokens','reasoningEffort','enabled']) {
