...
export async function tagBatch({ gateway, store, batchId, provider, limit, force = false, maxAgeHours = 168, workspaceRoot, onProgress = () => {} }) {
  const { prompt: tagSystem } = selectionPrompt({ workspaceRoot, skillName: 'hotspot-tagging', fallback: TAG_SYSTEM });
