 ...
 * 采集执行层（plugins/collectors/github-discovery/collector.mjs）只做搜索与归并，不感知 LLM。
 */
...
要求：
- 输出 3~${maxQueries} 组查询，覆盖内容支柱中最有读者价值的方向（如 AI Agent、MCP、开发工具、AI 工程实践，以及 AI 热点相关基础设施如推理引擎、模型服务）；
