...
export async function runDailyPipeline({ gateway, store, batchId, provider, workspaceRoot, snapshotId=null, stageSelections=null, focuses = [], focus = null, onProgress = () => {} }) {
  ...
  const lengthGate=runtime.config?.gates?.length||{minVisibleChars:1300,maxVisibleChars:1800};
  const minChars=Number(lengthGate.minVisibleChars||1300),maxChars=Number(lengthGate.maxVisibleChars||1800);
