...
export function buildArticleStageSystem(orchestrator, stage, ...children) {
  ...
  return [total, ...childPrompts, `## 当前运行阶段\n\n只执行 \`${stage}\` 阶段，严格遵守总契约中该阶段的输入、输出和门禁；不要提前执行其它阶段。本阶段为纯文本模型调用，没有文件读取或工具能力：阶段所需的子技能内容已随本系统消息提供，未提供的即本阶段不需要；总契约中"先读取子技能 SKILL.md"等文件操作指令由流水线在装配期完成，你不得索要、引用或等待任何文档，直接按已提供的契约输出。`].join('\n\n---\n\n');
}
