...
function buildInlineStyles(tokens, themeName = 'magazine-warm') {
  ...
  const styles = {
    article: `box-sizing:border-box;margin:0;padding:${articlePaddingPx}px;background:${background};color:${ink};font-family:${bodyFont};font-size:${bodyPx}px;line-height:${lineHeight};letter-spacing:${letterSpacing}em;${articleFrame}${variants.justify ? ';text-align:justify' : ''}`,
    ...
    h1: variants.h1 === 'invert-block'
      ? `background:${ink};color:${inverseText};padding:18px 18px 22px;font-size:${h1Px}px;line-height:1.3;margin:0 0 ${sectionPx}px;border-bottom:6px solid ${accent};font-weight:900;letter-spacing:${letterSpacing}em`
      : variants.h1 === 'center-double'
        ? `font-family:${headingFont};text-align:center;font-size:${h1Px}px;line-height:1.35;margin:0 0 ${sectionPx}px;padding:20px 4px 18px;border-top:6px double ${ink};border-bottom:1px solid ${ink};font-weight:700;letter-spacing:${letterSpacing}em`
      : variants.h1 === 'serif-display'
          ? `font-family:${headingFont};font-size:${h1Px}px;line-height:1.35;margin:0 0 ${sectionPx}px;padding:4px 0 16px;border-bottom:1px solid ${line};font-weight:700;color:${ink};letter-spacing:${letterSpacing}em`
          : variants.h1 === 'terminal-title'
            ? `font-family:${headingFont};font-size:${h1Px}px;line-height:1.3;margin:0 0 ${sectionPx}px;padding:4px 0 16px;border-bottom:1px solid ${line};font-weight:800;color:${ink};letter-spacing:${letterSpacing}em`
          : variants.serifHeadings
            ? `font-family:${headingFont};font-size:${h1Px}px;line-height:1.4;margin:0 0 ${sectionPx}px;padding-bottom:16px;border-bottom:1px solid ${line};font-weight:700;letter-spacing:${letterSpacing}em`
            : `font-size:${h1Px}px;line-height:1.35;margin:0 0 ${sectionPx}px;font-weight:900;color:${ink};letter-spacing:${letterSpacing}em`,
          ...
          : variants.quote === 'quote-marks'
            ...
            : variants.quote === 'plain-bar'
              ...
              : variants.quote === 'dark-block'
                ? `margin:${paragraphPx + 8}px 0;padding:${cardGapPx+6}px;background:${codeBackground};color:${inverseText};border-radius:12px;font-size:${bodyPx + 2}px;font-weight:700;line-height:${lineHeight};box-shadow:${shadow}`
    ...
    code: `font-family:${mono};background:${codeBackground};color:${inverseText};padding:2px 5px;border:${borderWidthPx}px solid ${line};border-radius:${Math.min(themeRadiusPx,6)}px`,
    ...
    codeBlock: `font-family:${mono};font-size:${Math.max(bodyPx - 2, 12)}px;line-height:1.65;color:${inverseText};white-space:pre`,
    ...
    th: `padding:10px 9px;border:${Math.max(1,borderWidthPx)}px solid ${line};background:${variants.table === 'dark-header' ? codeBackground : variants.table === 'ink-header' ? ink : surface};color:${variants.table === 'dark-header' || variants.table === 'ink-header' ? inverseText : ink};font-weight:700;text-align:left;word-break:break-word`,
