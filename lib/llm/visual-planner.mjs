const SYSTEM = `你是公众号文章可视化编辑，只提出真正提升理解效率的图表建议。
...
export async function planArticleVisuals({ gateway, provider, batchId, candidateId, markdown, factBase, preferences = [], maxOutputTokens = 5000 }) {
  const messages=[
