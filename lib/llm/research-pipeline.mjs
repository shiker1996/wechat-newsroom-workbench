...
export function breakingSynthesis(cards){return {items:cards.map((card)=>({candidateId:card.candidateId,saturationPenalty:0,audienceRelevance:Number(card.bScores?.audienceRelevance??0),reason:'突发单题不参与批次竞争'})),metaNarratives:[],combination:{}};}
