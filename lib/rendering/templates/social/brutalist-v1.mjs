...
export function renderBrutalistStoryboardSections({ topic, repository, pages, compositionMode = 'template', compositionSeed = '', forceSafeComposition = false, relaxedDensityPages = false, expandedDensityPages = false, contentType = 'repository', sourceLabel = '', disclosure = '', channelMode = 'wechat', coverTitleLines = null }) {
...
.template-brutalist-v1 .page-body{align-items:stretch;padding:15px 0}.template-brutalist-v1 .page-content-stack{min-height:100%;padding:19px 17px 17px;justify-content:flex-start;gap:11px;border:4px solid var(--ink);border-radius:0;background:var(--surface);box-shadow:8px 8px 0 var(--accentSecondary)}
...
.template-brutalist-v1.page-cover .page-content-stack{justify-content:flex-end;background:var(--accentSecondary)}.template-brutalist-v1.page-cover h1{font-size:40px;line-height:1.02}.template-brutalist-v1.page-cover .brutalist-title-line{display:block;width:max-content;max-width:100%;background:var(--ink);color:var(--inverse);padding:5px 8px;margin:3px 0;box-shadow:6px 6px 0 var(--accent);overflow-wrap:anywhere}.template-brutalist-v1.page-cover .brutalist-title-line:nth-child(even){background:var(--accent);color:var(--ink);box-shadow:6px 6px 0 var(--ink)}
