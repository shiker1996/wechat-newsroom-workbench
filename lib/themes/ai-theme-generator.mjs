...
const NUMBERS={
  'tokens.typography.bodyPx':[9,18,1],'tokens.typography.h1Px':[22,44,1],'tokens.typography.h2Px':[11,28,1],'tokens.typography.captionPx':[8,15,1],'tokens.typography.lineHeight':[1.2,2.1,.05],'tokens.typography.letterSpacingEm':[-.08,.2,.005],
  'tokens.spacing.articlePaddingPx':[0,40,1],'tokens.spacing.sectionPx':[12,48,1],'tokens.spacing.paragraphPx':[6,28,1],'tokens.spacing.cardGapPx':[0,28,1],'tokens.shape.radiusPx':[0,32,1],'tokens.shape.borderWidthPx':[0,8,1],
  'social.effects.decorationOpacity':[0,1,.05],'social.effects.contentTiltDeg':[-2,2,.1],
};
