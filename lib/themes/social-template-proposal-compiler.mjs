...
import { socialThemeDefinition } from './social-theme-compiler.mjs';
...
import { SOCIAL_CARD_RENDERER_BLOCK_TYPES, getSocialCardTemplatePack } from '../rendering/social-card-template-registry.mjs';
import { validateSocialTemplateProposal, SocialTemplateProposalError, SOCIAL_TEMPLATE_PROPOSAL_ERROR_CODES } from './social-template-proposal.mjs';
