...
export function auditThemeForPublish(input,{target=input?.targets?.[0]||''}={}){
  ...
  const colors=definition.tokens.colors,contrasts=target==='cover'?[
