...
export const SOCIAL_THEME_RECIPES=Object.freeze({
  ...
  ending:['dark-fill','accent-fill','hard-fill'],list:['soft-card','tinted-card','outlined-card','hard-card'],code:['dark-panel','terminal-panel','hard-panel'],
});
