...
// 封面主题（900×383 固定画布）的专属字阶/间距/形状范围：服务大标题、眉题、副标题、信息行与内容区留白
export const COVER_NUMERIC_LIMITS={
  'tokens.typography.titlePx':[30,56,1],
  'tokens.typography.titleLineHeight':[1.1,1.6,.02],
  'tokens.typography.eyebrowPx':[14,24,1],
  'tokens.typography.subtitlePx':[16,26,1],
  'tokens.typography.metaPx':[12,20,1],
  'tokens.spacing.paddingXPx':[24,64,1],
  'tokens.spacing.paddingYPx':[20,56,1],
  'tokens.spacing.gapPx':[8,32,1],
  'tokens.spacing.metaBottomPx':[12,48,1],
  'tokens.shape.badgeRadiusPx':[0,16,1],
};
...
export function themeNumericLimits({target='',source='builtin'}={}){
  if(target==='cover')return COVER_NUMERIC_LIMITS;
