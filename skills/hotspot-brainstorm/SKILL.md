...
`readerStake` 必须同时写明具体读者、要改变的决策或动作、以及工作/收入/岗位/效率/成本/选择中的具体后果。“影响职业方向”“影响技术选择”“影响工作环境”等泛化表述不合格。
传闻、未证实重大事件、健康或生物安全题默认进入实验池；不得靠情绪、主体知名度或标题张力晋级。没有读者利益点的宏观事件不得获得高 `audienceRelevance`。`notificationReason` 写明满足的硬条件；非通知池说明降级原因。
