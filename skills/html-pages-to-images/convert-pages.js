...
// 配置 - OpenClaw 爆火（每页独立优化版）
const HTML_FILE = resolve(__dirname, '..', '..', 'workspace', 'xiaohongshu-output', 'openclaw-hot', 'OpenClaw 爆火', 'OpenClaw 爆火.html');
const OUTPUT_DIR = resolve(__dirname, '..', '..', 'workspace', 'xiaohongshu-output', 'openclaw-hot', 'OpenClaw 爆火', 'images');
